...
void upsample_generic_Nd_kernel_impl(
  ...
  if (interp_size > 1) {
    ...
    AT_DISPATCH_FLOATING_TYPES_AND_UNIVERSAL_AND2(at::ScalarType::Byte, at::ScalarType::BFloat16,
...
void upsample_bilinear2d_kernel_impl(
  ...
  if (input.is_contiguous(at::MemoryFormat::ChannelsLast)) {
    AT_DISPATCH_FLOATING_TYPES_AND_UNIVERSAL_AND(at::ScalarType::BFloat16, input.scalar_type(), "upsample_bilinear2d_channels_last", [&] {
...
void upsample_trilinear3d_kernel_impl(
    ...
    c10::optional<double> scales_w) {
  if (input.is_contiguous(at::MemoryFormat::ChannelsLast3d)) {
    AT_DISPATCH_FLOATING_TYPES_AND_UNIVERSAL_AND(at::ScalarType::BFloat16, input.scalar_type(), "upsample_trilinear3d_channels_last", [&] {
