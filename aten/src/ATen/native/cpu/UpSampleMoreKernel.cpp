...
void upsample_linear1d_backward_kernel_impl(
  ...
  AT_DISPATCH_FLOATING_TYPES_AND_UNIVERSAL(grad_output.scalar_type(), "upsample_linear1d_backward", [&] {
...
void upsample_bilinear2d_backward_kernel_impl(
    ...
    c10::optional<double> scales_w) {
  AT_DISPATCH_FLOATING_TYPES_AND_UNIVERSAL(grad_output.scalar_type(), "upsample_bilinear2d_backward", [&] {
...
void upsample_trilinear3d_backward_kernel_impl(
    ...
    c10::optional<double> scales_h,
    c10::optional<double> scales_w) {
  AT_DISPATCH_FLOATING_TYPES_AND_UNIVERSAL(grad_output.scalar_type(), "upsample_trilinear3d_backward", [&] {
