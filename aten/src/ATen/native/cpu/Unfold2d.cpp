...
void unfolded2d_acc_kernel(
  ...
  if (is_channels_last) {
    AT_DISPATCH_FLOATING_TYPES_AND_UNIVERSAL_AND(at::ScalarType::BFloat16, dtype, "unfolded2d_acc_channels_last", [&] {
    ...
    AT_DISPATCH_FLOATING_TYPES_AND_UNIVERSAL_AND(at::ScalarType::BFloat16, dtype, "unfolded2d_acc", [&] {
      unfolded2d_acc(
          static_cast<scalar_t*>(finput_data),
          static_cast<scalar_t*>(input_data),
          kH, kW,
...
void unfolded2d_copy_kernel(
  ...
  if (is_channels_last) {
    AT_DISPATCH_ALL_TYPES_AND_UNIVERSAL_AND(at::ScalarType::BFloat16, dtype, "unfolded2d_copy_channels_last", [&] {
    ...
    AT_DISPATCH_ALL_TYPES_AND_UNIVERSAL_AND(at::ScalarType::BFloat16, dtype, "unfolded2d_copy", [&] {
      unfolded2d_copy(
          static_cast<scalar_t*>(input_data),
          static_cast<scalar_t*>(finput_data),
            kH, kW,
