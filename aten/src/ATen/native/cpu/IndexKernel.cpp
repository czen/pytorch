...
void index_kernel(TensorIterator& iter, IntArrayRef index_size, IntArrayRef index_stride) {
  AT_DISPATCH_ALL_TYPES_AND_COMPLEX_AND_UNIVERSAL_AND4(kComplexHalf, kHalf, kBool, kBFloat16,
...
void masked_fill_kernel(TensorIterator& iter, const Scalar& value) {
  AT_DISPATCH_ALL_TYPES_AND_COMPLEX_AND_UNIVERSAL_AND4(kComplexHalf, kBool, kBFloat16, kHalf,
...
void masked_select_serial_kernel(TensorIterator& iter, int64_t result_stride) {
  AT_DISPATCH_ALL_TYPES_AND_COMPLEX_AND_UNIVERSAL_AND3(ScalarType::Bool, ScalarType::BFloat16, ScalarType::Half,
...
void flip_kernel(TensorIterator& iter, const bool quantized) {
  if (quantized) {
    ...
    AT_DISPATCH_ALL_TYPES_AND_COMPLEX_AND_UNIVERSAL_AND3(kBool, kHalf, kBFloat16, iter.dtype(), "flip_cpu",
