...
TORCH_IMPL_FUNC(addmv_out_cpu)(const Tensor &self, const Tensor &mat, const Tensor &vec, const Scalar& beta_, const Scalar& alpha_, const Tensor& result) {
  ...
  if (mat.numel() == 0) {
    ...
    if (result.numel() != 0) {
      ...
      AT_DISPATCH_ALL_TYPES_AND_COMPLEX_AND_UNIVERSAL_AND(kBFloat16, mat.scalar_type(), "addmv_impl_cpu", [&] {
...
Tensor dot(const Tensor &self, const Tensor &other){
  ...
  return AT_DISPATCH_ALL_TYPES_AND_COMPLEX_AND_UNIVERSAL_AND2(at::ScalarType::Half, at::ScalarType::BFloat16, self.scalar_type(), "dot", [&] {
