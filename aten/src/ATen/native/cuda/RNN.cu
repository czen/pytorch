...
std::tuple<Tensor, Tensor, Tensor> _thnn_fused_lstm_cell_cuda(
  ...
  AT_DISPATCH_FLOATING_TYPES_AND_UNIVERSAL_AND(kHalf,input_gates.scalar_type(), "_thnn_fused_lstm_cell_cuda", [&] {
...
std::tuple<Tensor, Tensor, Tensor, Tensor, Tensor> _thnn_fused_lstm_cell_backward_cuda( const c10::optional<Tensor>& grad_hy_opt, const c10::optional<Tensor>& grad_cy_opt,
  ...
  AT_DISPATCH_FLOATING_TYPES_AND_UNIVERSAL_AND(kHalf,workspace.scalar_type(), "_thnn_fused_lstm_cell_cuda_backward", [&] {
    if (canUse32BitIndexMath(workspace)) { // See Note [64-bit index math check elision]
...
std::tuple<Tensor, Tensor> _thnn_fused_gru_cell_cuda(
  ...
  AT_DISPATCH_FLOATING_TYPES_AND_UNIVERSAL_AND(kHalf,input_gates.scalar_type(), "_thnn_fused_gru_cell_cuda", [&] {
    if (canUse32BitIndexMath(workspace)) { // See Note [64-bit index math check elision]
...
std::tuple<Tensor, Tensor, Tensor, Tensor, Tensor> _thnn_fused_gru_cell_backward_cuda(
  ...
  AT_DISPATCH_FLOATING_TYPES_AND_UNIVERSAL_AND(kHalf,grad_hy.scalar_type(), "_thnn_fused_gru_cell_cuda_backward", [&] {
    if (canUse32BitIndexMath(workspace)) { // See Note [64-bit index math check elision]
