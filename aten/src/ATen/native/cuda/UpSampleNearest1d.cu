...
static void upsample_nearest1d_out_cuda_template(
  ...
  AT_DISPATCH_FLOATING_TYPES_AND_UNIVERSAL_AND2(ScalarType::Half, ScalarType::Byte, input.scalar_type(), "upsample_nearest1d_out_frame", [&] {
...
static void upsample_nearest1d_backward_out_cuda_template(
  ...
  cudaStream_t stream = at::cuda::getCurrentCUDAStream();
  AT_DISPATCH_FLOATING_TYPES_AND_UNIVERSAL_AND2(ScalarType::Half, ScalarType::Byte, grad_output.scalar_type(), "upsample_nearest1d_backward_out_frame", [&] {
        using accscalar_t = at::acc_type<scalar_t, true>;
