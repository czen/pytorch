...
static void upsample_nearest2d_out_cuda_template(
  ...
  if (memory_format == at::MemoryFormat::ChannelsLast && channels >= 4 && \
    ...
    AT_DISPATCH_FLOATING_TYPES_AND_UNIVERSAL_AND2(ScalarType::Half, ScalarType::Byte, input.scalar_type(), "upsample_nearest2d_nhwc_out_frame", [&] {
    ...
    AT_DISPATCH_FLOATING_TYPES_AND_UNIVERSAL_AND2(ScalarType::Half, ScalarType::Byte, input.scalar_type(), "upsample_nearest2d_out_frame", [&] {
...
static void upsample_nearest2d_backward_out_cuda_template(
  ...
  if (memory_format == at::MemoryFormat::ChannelsLast && channels >= 4 && \
    ...
    AT_DISPATCH_FLOATING_TYPES_AND_UNIVERSAL_AND2(ScalarType::Half, ScalarType::Byte, grad_output.scalar_type(), "upsample_nearest2d_backward_nhwc_out_frame", [&] {
      using accscalar_t = at::acc_type<scalar_t, true>;
    ...
    cudaStream_t stream = at::cuda::getCurrentCUDAStream();
    AT_DISPATCH_FLOATING_TYPES_AND_UNIVERSAL_AND2(ScalarType::Half, ScalarType::Byte, grad_output.scalar_type(), "upsample_nearest2d_backward_out_frame", [&] {
      using accscalar_t = at::acc_type<scalar_t, true>;
