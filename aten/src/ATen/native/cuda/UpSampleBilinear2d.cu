...
static void upsample_bilinear2d_out_cuda_template(
  ...
  AT_DISPATCH_FLOATING_TYPES_AND_UNIVERSAL_AND(kHalf,input.scalar_type(), "upsample_bilinear2d_out_frame", [&] {
...
static void upsample_bilinear2d_backward_out_cuda_template(
  ...
  AT_DISPATCH_FLOATING_TYPES_AND_UNIVERSAL_AND(kHalf,grad_output_.scalar_type(), "upsample_bilinear2d_backward_out_frame", [&] {
