...
Tensor grid_sampler_3d_cpu(const Tensor& input, const Tensor& grid,
                           int64_t interpolation_mode, int64_t padding_mode,
                           bool align_corners) {
  return AT_DISPATCH_FLOATING_TYPES_AND_UNIVERSAL(input.scalar_type(), "grid_sampler3d_cpu", [&] {
...
grid_sampler_3d_backward_cpu(const Tensor& grad_output, const Tensor& input, const Tensor& grid,
                             int64_t interpolation_mode, int64_t padding_mode, bool align_corners) {
  return AT_DISPATCH_FLOATING_TYPES_AND_UNIVERSAL(input.scalar_type(), "grid_sampler_3d_backward_cpu", [&] {
