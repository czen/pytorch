...
AT_FORALL_SCALAR_TYPES_AND_UNIVERSAL_AND3(Bool, Half, BFloat16, DEFINE_CAST_OP)
...
Tensor& randperm_out_cpu(int64_t n, c10::optional<Generator> generator, Tensor& result) {
  ...
  AT_DISPATCH_ALL_TYPES_AND_UNIVERSAL_AND2(at::ScalarType::Half, at::ScalarType::BFloat16, result.scalar_type(), "randperm", [&]() -> void {
