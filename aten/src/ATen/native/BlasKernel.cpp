...
AT_FORALL_SCALAR_TYPES_AND_UNIVERSAL_AND(BFloat16, INSTANTIATE);
...
#define INSTANTIATE_DOT_IMPL_UNIVERSAL(T, NAME) \
  INSTANTIATE_DOT_IMPL(T);
AT_FORALL_UNIVERSAL_TYPES(INSTANTIATE_DOT_IMPL_UNIVERSAL)
#undef INSTANTIATE_DOT_IMPL_UNIVERSAL
