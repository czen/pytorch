...
Tensor isinf(const Tensor &self) {
  ...
  return AT_DISPATCH_FLOATING_TYPES_AND_UNIVERSAL_AND2(kBFloat16, kHalf, self.scalar_type(), "isinf", [&]() {
...
Tensor isfinite(const Tensor& self) {
  ...
  return AT_DISPATCH_FLOATING_TYPES_AND_UNIVERSAL_AND2(kHalf, kBFloat16, self.scalar_type(), "isfinite", [&]() {
