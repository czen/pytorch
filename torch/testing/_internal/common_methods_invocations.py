...
from torch.testing._internal.common_dtype import (
    ...
    all_types, double_types, empty_types, complex_types_and, integral_types, universal_types
)
...
op_db: List[OpInfo] = [
    ...
    UnaryUfuncInfo('bitwise_not',
                   ref=np.bitwise_not,
                   skips=(
                       DecorateInfo(unittest.skip('Does not support floating point types!'), 'TestUnaryUfuncs', 'test_batch_vs_slicing',
                                    dtypes=universal_types()),
                       DecorateInfo(unittest.skip('Does not support floating point types!'), 'TestUnaryUfuncs', 'test_contig_size1',
                                    dtypes=universal_types()),
                       DecorateInfo(unittest.skip('Does not support floating point types!'), 'TestUnaryUfuncs', 'test_contig_size1_large_dim',
                                    dtypes=universal_types()),
                       DecorateInfo(unittest.skip('Does not support floating point types!'), 'TestUnaryUfuncs', 'test_contig_vs_every_other',
                                    dtypes=universal_types()),
                       DecorateInfo(unittest.skip('Does not support floating point types!'), 'TestUnaryUfuncs', 'test_contig_vs_transposed',
                                    dtypes=universal_types()),
                       DecorateInfo(unittest.skip('Does not support floating point types!'), 'TestUnaryUfuncs', 'test_non_contig',
                                    dtypes=universal_types()),
                       DecorateInfo(unittest.skip('Does not support floating point types!'), 'TestUnaryUfuncs', 'test_non_contig_expand',
                                    dtypes=universal_types()),
                       DecorateInfo(unittest.skip('Does not support floating point types!'), 'TestUnaryUfuncs', 'test_non_contig_index',
                                    dtypes=universal_types()),
                       DecorateInfo(unittest.skip('Does not support floating point types!'), 'TestUnaryUfuncs', 'test_out_arg_all_dtypes',
                                    dtypes=universal_types()),
                       DecorateInfo(unittest.skip('Does not support floating point types!'), 'TestUnaryUfuncs', 'test_reference_numerics_extremal',
                                    dtypes=universal_types()),
                       DecorateInfo(unittest.skip('Does not support floating point types!'), 'TestUnaryUfuncs', 'test_reference_numerics_hard',
                                    dtypes=universal_types()),
                       DecorateInfo(unittest.skip('Does not support floating point types!'), 'TestUnaryUfuncs', 'test_reference_numerics_normal',
                                    dtypes=universal_types()),
                   ),
    ...
    BinaryUfuncInfo('bitwise_or',
                    ...
                    skips=(
                        ...
                        DecorateInfo(unittest.skip('Does not support floating point types!'),
                                     'TestBinaryUfuncs',
