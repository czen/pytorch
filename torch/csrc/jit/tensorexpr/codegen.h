...
#define ARG_TYPE_CTOR(Type, Name)     \
  ...
  // NOLINTNEXTLINE(cppcoreguidelines-pro-type-member-init)
  AT_FORALL_SCALAR_TYPES_AND4(Bool, Half, BFloat16, CFloatWithSubnormals, ARG_TYPE_CTOR);
#undef ARG_TYPE_CTOR
...
#define ARG_PTR_DEFINE(Type, Name) \
  ...
  // NOLINTNEXTLINE(cppcoreguidelines-pro-type-const-cast)
  AT_FORALL_SCALAR_TYPES_AND4(Bool, Half, BFloat16, CFloatWithSubnormals, ARG_PTR_DEFINE);
